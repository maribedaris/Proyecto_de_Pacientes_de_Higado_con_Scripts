...
|---|---|---|
| `pacientes_higado_clasificacion-gaussiannb-v2.joblib` está en `models/` (raíz) — ver [models/README.md](../README.md) | Modelo histórico seleccionado | Ganador de la comparación histórica (f1_macro 0,741) |
